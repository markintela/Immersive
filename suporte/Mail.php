...
if (isset($_POST['txtdest']))
{
	...
	$headers .= "From: contato@marcusquintela.com".$quebra; //E-mail do remetente
	$headers .= "Return-Path: contato@marcusquintela.com".$quebra; //E-mail do remetente
	mail($destino, $assunto, $mensagem, $headers, "-r". "contato@marcusquintela.com");
